...
using onset as the dependent variable. With a standard glm model we were able to recreate column 1 of table 1. Our numbers match the papers numbers.
...
### Some more validations on the logit model 1 
